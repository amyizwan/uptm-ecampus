...
<html>
<head>
    <title>Create Assignment - UPTM eCampus</title>
            ...
            <div class="col-md-9 col-lg-10 ml-sm-auto px-4 py-4">
                <div class="card shadow-sm">
                    <div class="card-header bg-uptm-blue text-white">
                        <h4 class="mb-0"><i class="fas fa-plus me-2"></i>Create New Assignment</h4>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('assignments.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="d-flex gap-2 mt-4">
                                <button type="submit" class="btn btn-uptm-blue">
                                    <i class="fas fa-paper-plane me-1"></i>Create Assignment
                                </button>
