...
<html>
<head>
    <title>{{ $assignment->title }} - UPTM eCampus</title>
            ...
            <div class="col-md-9 col-lg-10 ml-sm-auto px-4 py-4">
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            <div class="col-md-8">
                                <h5 class="text-uptm-blue">Assignment Details</h5>
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p><strong>Lecturer:</strong> {{ $assignment->lecturer->name ?? 'Unknown Lecturer' }}</p>
...
@endif
                        ...
                        @if(Auth::user()->role === 'lecturer' || Auth::user()->role === 'admin')
                            <div class="card mt-4">
                                <div class="card-header bg-light">
                                    <h6 class="mb-0"><i class="fas fa-cogs me-2"></i>Assignment Management</h6>
                                </div>
                                <div class="card-body">
                                    <div class="d-flex gap-2">
                                        <a href="{{ route('assignments.edit', $assignment) }}" class="btn btn-uptm-blue">
                                            <i class="fas fa-edit me-1"></i>Edit Assignment
                                        </a>
                                        <form method="POST" action="{{ route('assignments.destroy', $assignment) }}" class="d-inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-uptm-red" onclick="return confirm('Are you sure you want to delete this assignment?')">
